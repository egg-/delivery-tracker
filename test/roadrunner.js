...
const courier = tracker.courier(tracker.COURIER.ROADRUNNER.CODE)

describe(tracker.COURIER.ROADRUNNER.NAME, function () {
  ...
  it('delivered number', function (done) {
    courier.trace(deliveredNumber, function (err, result) {
      ...
      assert.equal(tracker.COURIER.ROADRUNNER.CODE, result.courier.code)
